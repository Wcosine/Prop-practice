...
const messages = ref([
  {id:1, author:"Anne" ,content: "這是練習" },
  {id:2, author:"Bryan" ,content: "這是試煉!" },
  {id:3, author:"Chloe" ,content: "天要亡我..." },
  {id:4, author:"Dora" ,content: "我終將無所不能!" },
])
...
<template>
    ...
    <ul class="message-list">
      ...
      <!-- 迴圈帶入messages資料 -->  
        ...
        <!-- 當我點擊時, (id)傳入openDetailModal, 即為msg_id帶入 -->
      </li>
    </ul> 
...
<!--
    ...
    2. 綁定prop visible、showCloseX, 並設定值傳給子組件, 控制視窗開關
-->
